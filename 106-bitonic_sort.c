...
/**
 * bitonic_compare - sort the values in a sub-array with
 * respect to the bitonic sort algorithm
...
/**
 * bitonic_sort - sorts an array of integersin ascending order using
